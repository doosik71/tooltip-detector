...
A copy of baseline/yolov8s/common/sources.py. Every sub-project is
deliberately independent, so each carries its own copy rather than importing
across the boundary.
...
def repo_root() -> str:
    ...
    here = os.path.dirname(os.path.abspath(__file__))     # standalone/jetson/yolov8s/common
