...
Usage:
    ...
    ./baseline/yolov8s/run prepare-dataset --dataset erop --frame-stride 1 --splits train val test
"""
...
def write_yaml(prepared_root: str, splits: dict) -> str:
    ...
    lines = [
        "# Generated by baseline/yolov8s/scripts/prepare-dataset.py -- do not edit.",
...
def main():
    ...
    print(f"next    ./baseline/yolov8s/run train-model --dataset {args.dataset}")
